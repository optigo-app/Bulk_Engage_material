    ...
    <div className="confirmation page-enter">
      ...
      <div className="confirmation__review-card">
        ...
        <div className="confirmation__review-content">
          ...
          <p>You are about to engage <strong>{state.scannedJobs.length} jobs</strong> with <strong>{state.scannedBags.length} bags</strong> for employee <strong>{state.employee?.name}</strong> in <strong>{state.locker?.name}</strong>.</p>
